...
public final class ToastUtils {
    ...
    private static int yOffset = (int) (64 * DataContextEngineUtil.getContext().getResources().getDisplayMetrics().density + 0.5);
    ...
    public static void setView(@LayoutRes int layoutId) {
        LayoutInflater inflate = (LayoutInflater) DataContextEngineUtil.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    private static void show(@StringRes int resId, int duration) {
        show(DataContextEngineUtil.getContext().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void show(@StringRes int resId, int duration, Object... args) {
        show(String.format(DataContextEngineUtil.getContext().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(CharSequence text, int duration) {
        ...
        if (sViewWeakReference != null) {
            final View view = sViewWeakReference.get();
            if (view != null) {
                sToast = new Toast(DataContextEngineUtil.getContext());
                sToast.setView(view);
        ...
        if (!isCustom) {
            if (messageColor != DEFAULT_COLOR) {
                ...
                sToast = Toast.makeText(DataContextEngineUtil.getContext(), spannableString, duration);
            } else {
                sToast = Toast.makeText(DataContextEngineUtil.getContext(), text, duration);
            }
        }
