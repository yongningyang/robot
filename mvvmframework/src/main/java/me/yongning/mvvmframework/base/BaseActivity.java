...
import me.yongning.mvvmframework.R;
import me.yongning.mvvmframework.base.BaseViewModel.ParameterField;
import me.yongning.mvvmframework.bus.Messenger;
import me.yongning.mvvmframework.utils.MaterialDialogUtils;
import me.yongning.mvvmframework.utils.SystemStatusManager;
...
public abstract class BaseActivity<V extends ViewDataBinding, VM extends BaseViewModel> extends RxAppCompatActivity implements IBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTheme(((IThemeIdGetter) BaseApplication.getInstance()).getThemeId());
        //页面接受的参数方法
        initParam();
    ...
    protected int getTitleColorResourceId() {
        return R.color.titlebar;
    }

    protected void setTranslucentStatus(int tintBarColorResId) {
        //判断版本是4.4以上
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            tintManager.setStatusBarTintResource(tintBarColorResId);//设置背景

        }
    }

    protected void setNavigationBarColor(int res) {
