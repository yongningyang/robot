...
import me.yongning.mvvmframework.crashlooper.CrashLooper;
import me.yongning.mvvmframework.crashlooper.ExceptionHandler;
...
public final class CustomActivityOnCrash {
    ...
    private static void doWhenCrash(Thread thread, Throwable throwable, Thread.UncaughtExceptionHandler oldHandler) {
        if (config.isEnabled()) {
    ...
    public static void install(@Nullable final Context context) {
        try {
            if (context == null) {
                ...
                if (config.isEnableBreakpad()) {
                    String absolutePath = Environment.getExternalStorageDirectory().getAbsolutePath();
                    NativeBreakpad.init(absolutePath);
                }
                ...
                if (oldHandler != null && oldHandler.getClass().getName().startsWith(CAOC_HANDLER_PACKAGE_NAME)) {
                    ...
                    if (config.isEnableNeverCrash()) {
                        ...
                        CrashLooper.install(exceptionHandler);
                        ...
                        Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
                            ...
                            public void uncaughtException(Thread thread, final Throwable throwable) {
                                doWhenCrash(thread, throwable, oldHandler);
                            }
                        });
                    }
