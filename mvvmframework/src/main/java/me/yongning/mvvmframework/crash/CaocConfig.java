package me.yongning.mvvmframework.crash;
...
public class CaocConfig implements Serializable {
    ...
    private boolean enableBreakpad = true;
    private boolean showErrorDetails = true;
    private boolean showRestartButton = true;
    private boolean trackActivities = false;
    private boolean enableNeverCrash = true;
    ...
    public boolean isEnableBreakpad() {
        return enableBreakpad;
    }

    public void setEnableBreakpad(boolean enableBreakpad) {
        this.enableBreakpad = enableBreakpad;
    }
    ...
    public boolean isEnableNeverCrash() {
        return enableNeverCrash;
    }
    ...
    public static class Builder {
        ...
        public static Builder create() {
            ...
            config.enableBreakpad = currentConfig.enableBreakpad;
            config.enableNeverCrash = currentConfig.enableNeverCrash;
         ...
         * 启用Breakpad， 默认不启用
         *
         * @param enableBreakpad
         * @return
         */
        public Builder enableBreakpad(boolean enableBreakpad) {
            config.enableBreakpad = enableBreakpad;
            return this;
        }
        ...
        public Builder enableNeverCrash(boolean enable) {
            config.enableNeverCrash = enable;
            return this;
        }
    }
